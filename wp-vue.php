...
class WPVue {
    ...
    public function loadAssets() {
        ...
        wp_enqueue_script( 'wp-vue-core', plugin_dir_url( __FILE__ ) . '/dist/assets/index-8f49c5a2.js', [], time(), true );
        wp_enqueue_style( 'wp-vue-core', plugin_dir_url( __FILE__ ) . '/dist/assets/index-5b250a0c.css', [], time() );
